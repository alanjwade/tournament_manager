...
function RingOverview({ globalDivision }: RingOverviewProps) {
  ...
  // Sort checkpoints from newest to oldest
  ...
  return (
    <div style={{ display: 'flex', gap: '15px', height: '100vh' }}>
      ...
      <div style={{ 
        ...
        <div
          onClick={() => setGrandChampionExpanded(!grandChampionExpanded)}
          style={{
        ...
        >
          <span>
            {grandChampionExpanded ? '▼' : '▶'} Grand Champion Rings ({customRings.length})
                            ...
                            onClick={async () => {
                              ...
                              try {
                                ...
                                const mockRing: CompetitionRing = {
                                  ...
                                  physicalRingId: 'GC',
                                  categoryId: 'custom',
                                  division: ring.name, // Division must match what we pass to the function
                                  type: ring.type,
        ...
        {sortedCheckpoints.length === 0 ? (
          ...
          sortedCheckpoints.map((checkpoint) => (
            <CheckpointItem
              ...
              onLoad={() => loadCheckpoint(checkpoint.id)}
            />
          ))
        )}
      </div>
